...
| 4 coverage | Exactly 150 nonbonus HSK1; every word in ≥3 curriculumIndex scenes and the starter ten in S00–S03 (≥4 each), for at least 460 scene-word placements; count S11, never generic consequences; bonus ≤10, current plan exactly1 |
...
| 8 audio | Every resolved ID manifest entry/file/hash; matching text, speaker, slot key; mono 48kHz Opus ≤32kbps nominal; duration 0.25…6 s and cap 8/12/16/24 KB at ≤2/3/4/6 s; no stale artifacts referenced |
